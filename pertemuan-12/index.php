...
<body>
  ...
  <main>
    ...
    unset($_SESSION["flash_sukses"], $_SESSION["flash_error"], $_SESSION["old"], $_SESSION['old']);
    ?>
    ...
    <section id="contact">
      ...
      <?php if (!empty($flash_sukses)) : ?>
        <div style="padding: 10px; background-color: #d4e8edff; color: #151657ff; border: 1px solid #cdc3e6ff; margin-bottom: 15px;">
          <?= $flash_sukses; ?>
        </div>
      <?php endif; ?>
      ...
      <form action="proses.php" method="POST">
        ...
        2 + 3 = <input type="number" name="captcha">
